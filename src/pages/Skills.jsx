        ...
        <AnimatePresence>
          {filteredSkills.map((skill, index) => (
            <motion.div
              ...
              className="hover:bg-gray-800 w-100 rounded-xl p-4 flex gap-3 items-center hover:shadow-blue-500/20 cursor-pointer transform transition-all hover:-translate-y-2 shadow-sm border border-light"
            >
              <img
                src={skill.img}
                alt={skill.name}
